# res://scripts/pets/pengpet.gd
extends CharacterBody2D

## ============================================================================
## PENGPET - Player's Pet Companion
## ============================================================================
## This script controls the pengpet that follows the player around
## The pengpet stays near the player and animates based on movement
## ============================================================================

## Movement settings
var follow_speed: float = 100.0  # How fast the pengpet moves
...
func _ready() -> void:
	...
	if not animated_sprite:
		print("[Pengpet] Warning: AnimatedSprite2D not found!")
...
func find_player() -> void:
	...
	if player:
		...
		print("[Pengpet] Ready! Following player.")
	else:
		print("[Pengpet] Error: Player not found!")
